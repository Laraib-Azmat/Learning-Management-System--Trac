  ...
  return (
    <section className="p-6 bg-gray-100 min-h-screen">
      <div className="flex items-center justify-evenly">
        <div
          className="flex flex-col items-center justify-center w-40 h-40 rounded-full bg-gray-200 overflow-hidden cursor-pointer"
      ...
      <section className="p-6 bg-gray-100">
        <div className="max-w p-2 mx-auto justify-center bg-white rounded-lg shadow-md overflow-hidden">
          <div>
            ...
            <div className="flex space-x-8">
              <div className="border-l-4 border-gray-300 pl-4">
                ...
                <div className="flex space-x-4 overflow-x-auto scrollbar">
                  {visibleCourses.map((course) => (
                    <div
                      key={course.id}
                      className="bg-white border border-black rounded-lg shadow-md w-64"
                    >
                      <img
                        src={course.image}
                        alt={course.title}
              ...
              <div className="border-l-4 border-gray-300 pl-4">
                ...
                <div className="flex space-x-4 max-width-[200px] overflow-x-auto scrollbar">
                  {visibleCourses.map((course) => (
                    <div
                      key={course.id}
                      className="bg-white border border-black rounded-lg shadow-md w-64"
