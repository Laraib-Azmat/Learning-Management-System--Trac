    ...
    return (
        ...
        <div className='flex gap-4 items-center'>
          ...
          <a href='https://www.instagram.com/tractaxila?igsh=MTA2NHB4a3p1Zjd6dA==' target='_blank' rel='noopener noreferrer'>
            <img className='h-[20px] sm:h-[25px] cursor-pointer hover:scale-110 transition-transform' src={instagramicon} alt='Instagram' />
          </a>
          <a href='https://youtube.com/@tracuettaxila?si=7ci-gVmEZ36HOlGn' target='_blank' rel='noopener noreferrer'>
            <img className='h-[25px] sm:h-[25px] cursor-pointer hover:scale-110 transition-transform' src={youtubeicon} alt='YouTube' />
          </a>
          <a href='https://www.linkedin.com/company/tractaxila/' target='_blank' rel='noopener noreferrer rounded-lg'>
            <img className='h-[20px] sm:h-[25px] cursor-pointer hover:scale-110 transition-transform rounded-lg' src={linkedinicon} alt='LinkedIn' />
          </a>
        </div>
      </div>
    )
